...
function hub_attack(nwork::LightGraphs.Graph,nw_vert_empty::Array{node,1}, nw_mat::Array{Float64,2},ant_to_node::Float64,chosen::Int64)
...
function Sim_network_DR(ntype::String,mean_edges::Int64)
    ...
    result_vector = [hub_attack(nwork,deepcopy(nw_vert_empty),nw_mat,ant_con,node_to_attack) for ant_con in ant_range]
    return result_vector
end
            
function nsim_dr_watts(mean_edges::Int64)
...
function nsim_dr_erdos(erdos_edges::Int64)
