...
function nsim_dr_watts(n::Int64,mean_edges::Int64)
    ...
    writedlm("ANT/ant_$(mean_edges)edges_watts_dist",transpose(reshape(ant_vector_tofile,node_num,n)))
end
...
function nsim_dr_erdos(n::Int64,mean_edges::Int64)
    ...
    writedlm("ANT/ant_$(mean_edges)edges_erdos_dist",transpose(reshape(ant_vector_tofile,node_num,n)))
end
...
function sim_empty_network(reps::Int64,mean_edges::Int64)
    ...
    writedlm("ANT/ant_$(mean_edges)edges_watts_dist",ant_vector_tofile)
end