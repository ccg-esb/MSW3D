const node_num = 60 #Number of different diffusion coefficients (equal to rownumbers)
const mean_edges = 2 #Mean number of connections between microenvironments
const chan_len = 0.06 #Width of the connections
const ant_to_node = 60. #Antibiotic concentration for "attack"

#For the density simulator, the range of edge number
const edge_range = 150:1200

#Watts parameter fowattsr network rewiring
