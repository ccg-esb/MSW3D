...
#Connective rectangles
    ...
    #colorbar
    x_s1,colbar_y_01,indiv_widths1,colbar_wid1,cbar_cmap1,annot_colbar1 = plot_vert_cmap(1-right_space*(3/4),0.2,0.2,right_space/3,"RdBu","RRF")
    ...
    (context(),text(annot_colbar1...),fontsize(20pt),font("Helvetica")),
    (context(),text(annot_colbar2...),fontsize(20pt),font("Helvetica")))
...
function plot_vert_cmap(x0::Float64,y0::Float64,len::Float64,width::Float64,colorname::String,varname::String,n_colors=1000)
    ...
    if varname=="Greens"
        cbar_map = cbar_map[end:-1:1]
    end
    
    # colorbar text
    colbar_title_x, colbar_title_y, colbar_title = (colbar_x_0 +0.001 * (4-length(varname)) ,colbar_y_0 - 0.03,varname)
...
5
    ...
    return ([colbar_x_0],y0_s,[colbar_wid],indiv_len,cbar_map,annot_colbar)
end